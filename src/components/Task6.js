      ...
      <div className="row shadow-lg sticky-top bg-dark rounded">
       ...
       <div className="row home-custom" id="home-custom">
        ...
        <div className="offset-2 col-4">
          <img src={require('file:///C:/Users/nalam/OneDrive/Pictures/Screenshots/Screenshot%202023-03-04%20123036.png')} alt="Image" className="img-fluid rounded-circle" width="500rem" height="500rem" />
        </div>
      </div>
       <div className="row about-custom  pt-4 pb-5 mb-5 " id="about-custom">
        ...
        <div className="offset-1 col-4 pt-4">
          <img src={require('file:///C:/Users/nalam/OneDrive/Pictures/Screenshots/Guna_Photo.jpg')} alt="Photo" className="img-fluid rounded-circle" height="10rem" width="500rem" />
        </div>
